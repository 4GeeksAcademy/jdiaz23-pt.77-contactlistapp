...
import { getContacts, updateContact, deleteContact, addContact } from "../pages/actions";
...
export default function useGlobalReducer() {
    const { dispatch, store, getContacts, updateContact, deleteContact, addContact } = useContext(StoreContext)
    return { dispatch, store, getContacts, updateContact, deleteContact, addContact};
}